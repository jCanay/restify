    ...
    return (
        <>
            ...
            <main className="restaurant-detail-page container">
                ...
                <Dialog open={productOpen} onOpenChange={handleOpenChange}>
                    <Outlet
                        context={{
                ...
                <div className="faq">
                    ...
                    <details onToggle={handleFAQToggle} name="faq">
                        ...
                        <p>
                            El tiempo estimado de entrega suele ser de entre 30
                            y 45 minutos. Este plazo puede variar ligeramente
                            dependiendo de la cantidad de comandas en cocina y
                            de la distancia del repartidor hasta tu ubicación.
                        </p>
                    </details>
                    <details onToggle={handleFAQToggle} name="faq">
                        <summary>
                        ...
                        <p>
                            ¡Sí, claro! Al avanzar al proceso de pago, podrás
                            seleccionar si deseas recibir tu comida lo antes
                            posible o elegir una hora específica del día de hoy
                            para que se entregue exactamente cuando lo
                            necesites.
                        </p>
                    </details>
                    <details onToggle={handleFAQToggle} name="faq">
                        ...
                        <p>
                            Si tienes un cupón promocional, verás un campo de
                            texto dedicado a ello en la pantalla de
                            confirmación, justo antes de proceder al pago
                            definitivo. El descuento se verá reflejado
                            inmediatamente en el precio total.
                        </p>
                    </details>
                    <details onToggle={handleFAQToggle} name="faq">
                        <summary>
                            <h4>
                                ¿Qué hago si tengo una alergia o intolerancia
                                alimentaria?
                            </h4>
                            <ChevronDown />
                        </summary>
                        <p>
                            Dentro de la ficha detallada de cada producto (al
                            hacer click sobre la tarjeta del plato), encontrarás
                            la lista completa de alérgenos declarados. Además,
                            puedes dejarnos una nota con indicaciones especiales
                            para la cocina antes de añadirlo al carrito.
                        </p>
                    </details>
                    <details onToggle={handleFAQToggle} name="faq">
                        <summary>
                            <h4>
                                ¿Puedo cancelar o modificar mi pedido una vez
                                confirmado?
                            </h4>
                            <ChevronDown />
                        </summary>
                        <p>
                            Debido a que el restaurante comienza a preparar los
                            alimentos de inmediato para asegurar la máxima
                            calidad, las modificaciones o cancelaciones solo se
                            permiten durante los primeros 2 minutos posteriores
