...
import { $hasAnimatedConfirmation, $setupDataStore } from "../../contexts/setupDataStore";
import { useEffect, useState } from "react";

function RestaurantDataConfirmation({ onBackClick }) {
	const { name, address, radius, schedule } = useStore($setupDataStore);
	...
	return <div className="restaurant-data-confirmation">
		...
		<p>Revisa los datos de tu restaurante. Puedes volver atrás si lo necesitas.</p>
		<form className={`${shouldAnimate && "animated"} `}>
			...
			<div className="street">
				...
				<p>{!address.street ? "[Dirección de la calle]" : address.street}</p>
			</div>
			<div className="city">
				<label>Ciudad</label>
			...
			<div className="postalCode">
				...
				<p>{!address.zipcode ? "[Código postal]" : address.zipcode}</p>
			</div>
