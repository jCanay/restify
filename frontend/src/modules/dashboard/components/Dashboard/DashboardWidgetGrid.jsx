...
import BookingToday from "../../widgets/booking/Today/BookingToday";
import OrderBestSelling from "../../widgets/order/BestSelling/OrderBestSelling";
import OrderSalesPerformance from "../../widgets/order/SalesPerformance/OrderSalesPerformance";
import OrderLastCard from "../../widgets/order/Last/OrderLastCard";
import OrderLast from "../../widgets/order/Last/OrderLast";
import OrderGeneralSummary from "../../widgets/order/GeneralSummary/OrderGeneralSummary";
...
const formatWidgetLayouts = (widgets) => {
...
export default function DashboardWidgetGrid({ widgets, pageId }) {
	...
	const layouts = useMemo(() => {
		...
		if (widgets.length > 0) {
			console.log(formatWidgetLayouts(widgets));

			return formatWidgetLayouts(widgets);
		}
